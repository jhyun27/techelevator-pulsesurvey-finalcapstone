        ...
        <div class="form">
            <div class="vue-csv-uploader">
                <div class="form-group csv-import-file">
                    <input class="button" ref="csv" type="file" @change.prevent="validFileMimeType" :class="inputClass" name="csv">
                ...
                <div class="vue-csv-mapping">
                    <div class="form-group">
                        <slot name="submit" :submit="submit">
                            <v-btn class="button" color="success" name="submit" :class="buttonClass" @click.prevent="submit" :value="submitBtnText">Submit</v-btn>
                        </slot>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            fieldsToMap: [],
            map: {present: 0, studentName: 1, studentId: 2, totalScore: 3, numberCorrect: 4, pace: 5, interest: 6, understanding: 7, energyEntry: 8},
            hasHeaders: true,
            csv: null,
            sample: null,
        ...
        methods: {
            ...
            submit() {
                ...
                this.$emit('uploadFile', this.form.csv);
                if (this.url) {
